    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Pengambilan Material Batal</span></li>
            </ol>
...
<form method="POST" action="<?= base_url()?>pengambilanMaterialProduksi/batal_pengambilan_material">
    <div name="isi_halaman">
        <header class="panel-heading">
            <h2 class="panel-title">Pengambilan Material Batal</h2>
        </header>
