                                ...
                                ?>
                                        <tr id="re_bg1<?= $ke ?>">
                                            <td class="col-md-6">
                                                ...
                                                <input type="text" class="input_bgpo1 info_produk1" id="nama_customer1<?= $pt->id_detail_purchase_order_customer?>"
                                                value="<?= $pt->id_customer?>">
                                                <input type="text" class="input_bgpo1 info_produk1" id="nama_produk1<?= $pt->id_detail_purchase_order_customer?>"
                                                value="<?= $pt->nama_produk?>">
                                                <input type="text" class="input_bgpo1 info_produk1" id="id_produk1<?= $pt->id_detail_purchase_order_customer?>"
                                                value="<?= $pt->id_produk?>">
