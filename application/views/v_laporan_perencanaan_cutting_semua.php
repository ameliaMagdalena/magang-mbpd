    ...
    $('.bdet1_klik').click(function(){
        ...
        $.ajax({
            ...
            success: function(respond){
                $("#tanggal_det1").val(respond['percut'][0]['tanggal_percut']);
...
<script>
    $('.bdet2_klik').click(function(){
        ...
        $.ajax({
            ...
            success: function(respond){
                $("#tanggal_det2").val(respond['percut'][0]['tanggal_percut']);
...
<script>
    $('.bedit_klik').click(function(){
        ...
        $.ajax({
            ...
            success: function(respond){
                $("#tanggal_edit").val(respond['percut'][0]['tanggal_percut']);
    ...
    $('.bse7_klik').click(function(){
        ...
        $.ajax({
            ...
            success: function(respond){
                ...
                $("#tanggal_perencanaannya").html(tanggal);
