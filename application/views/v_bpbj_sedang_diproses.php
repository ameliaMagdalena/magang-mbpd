    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>BPBJ Sedang Diproses</span></span></li>
            </ol>
...
<!--KODINGAN ISI HALAMAN-->
    <div name="isi_halaman">
        <header class="panel-heading">
            <h2 class="panel-title">Data BPBJ Sedang Diproses</h2>
        </header>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td  style="text-align: center;vertical-align: middle;">Sedang Diproses
                            </td>
                            <td class="col-lg-3">
