            ...
            success: function(respond){
                ...
                for($i=0;$i<respond['jm_detpermat'];$i++){
                    if(respond['detpermat'][$i]['id_detail_permintaan_material'] == $id_one_pengmat){
                        ...
                        $wip = $wip + parseFloat(respond['one_pengmat'][0]['stok_wip']);
                        ...
                        '<tr>'+
                            '<td style="text-align: center;vertical-align: middle;">'+
                                ...
                                '<input type="text" name="id_pengmat_ed" value="'+respond['one_pengmat'][0]['id_pengambilan_material']+'" >'+
                            '</td>'+
                            '<td style="text-align: center;vertical-align: middle;">'+
                            ...
                            '<td style="text-align: center;vertical-align: middle;">'+
                                ...
                                '<center><input type="number" min="0" step=".01" class="form-control" name="jumlah_lama" id="jumlah_lama" value="'+$jumlah_ambil_sebelum+'" readonly></center>'+
                                '<center><input type="number" min="0" step=".01" class="form-control" name="jumlah_wip_lama" id="jumlah_wip_lama" value="'+respond['one_pengmat'][0]['stok_wip']+'" readonly></center>'+
                            '</td>'+
                            '<td style="text-align: center;vertical-align: middle;">'+
                                respond['detpermat'][$i]['satuan_keluar']+
                            '</td>'+
                            '<td style="text-align: center;vertical-align: middle;">'+
                                '<textarea class="form-control" name="keterangan" rows="3" id="textareaDefault"></textarea>'+
                            '</td>'+
                        '</tr>';
                    }
                }
