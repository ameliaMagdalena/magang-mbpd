...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Permintaan Material Yang Belum Diambil</h2>
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Permintaan Material Yang Belum Diambil</span></span></li>
            </ol>
...
<!--KODINGAN ISI HALAMAN-->
    <div name="isi_halaman">
        <header class="panel-heading">
            <h2 class="panel-title">Data Permintaan Material Yang Belum Diambil</h2>
        </header>
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                <tbody>
                    <tr>
                        ...
                        <td  style="text-align: center;vertical-align: middle;">Disetujui & Belum Diambil</td>
                        <td class="col-lg-3"> 
