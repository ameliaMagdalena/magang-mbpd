...
class Pdfx extends TCPDF
{
    ...
    public function Footer() {
        ...
        <p>
        <hr style='width:98%;'>
        <br><br><span style='font-size: medium'>PT Maju Bersama Persada Dayamu</span> - Surat Perintah Lembur
        </p>";
        $this->SetFontSize(8);
    ...
    //isi pdf
        ...
        $pdf->SetTitle('Surat Perintah Lembur ');
        $pdf->SetTopMargin(20);
        ...
        for($i=0;$i<$jm_dspl;$i++){
            $isi_table = $isi_table.
                        '<tr>
                            ...
                            <td style="text-align: center;vertical-align: middle">'.$dspl[$i]['planning_lembur'].'</td>
                            <td style="text-align: center;vertical-align: middle">'.$dspl[$i]['waktu_in_plan'].'</td>
                            <td style="text-align: center;vertical-align: middle">'.$dspl[$i]['waktu_out_plan'].'</td>
                            <td style="text-align: center;vertical-align: middle">'.$dspl[$i]['keterangan_plan'].'</td>
                        </tr>';
        }
        ...
        $table = '<table border="1" style="border-collapse: collapse;padding:5px">
                    <tr>
                        ...
                        <td rowspan="2" style="text-align: center;vertical-align: middle;width:75px"><b>PLANNING LEMBUR</b></td>
        ...
        $keterangan = '<table border="1" style="padding:5px">
                            <tr>
                                <td>'.$spl[0]['keterangan_perintah'].'</td>
                            </tr>
                        </table>';
