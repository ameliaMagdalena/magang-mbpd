...
<h1>Jadwal Pengambilan Material</h1>
<hr>
    ...
    $calendar.fullCalendar({
        ...
        events: [
            ...
            }, */
            {
                ...
                description: 'No. DN: DN-1/232/20',
                url: '#modaldetail',
                className: 'fc-event-default'
            },
            {
                title: 'INOAC',
                start: new Date(y, m, d, 15, 00),
                description: 'No. DN: DN-2/260/20',
                url: '#modaldetail',
            ...
            },
            {
                ...
                description: 'No. DN: DN-3/262/20',
                className: 'fc-event-warning'
            },
            {
                title: 'PT AAA',
                start: new Date(y, m, 28, 12, 30),
                description: 'No. DN: DN-4/293/20',
                className: 'fc-event-warning'
            }
        ],
