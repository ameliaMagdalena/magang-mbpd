        ...
        for($i=0;$i<$jmid_prod;$i++){
            ...
            for($t=0;$t<$jmprodline;$t++){
                ...
                for($y=0;$y<$jmdetprodline;$y++){
                    ...
                    if($t == 0){
                        $id_awal_detprodline =  $id_detail_produksi_linenya;
                    }
                    if($t == 27){
                        $id_akhir_detprodline =  $id_detail_produksi_linenya;
                    }
                    ...
                    //update status SPL 
                    //$tanggal_spl = $detprodline[$y]['tanggal'];
                    //$id_line_spl = $detprodline[$y]['id_line'];
                ...
                /*
                    ...
                    echo $tanggal_spl." -- ".$id_line_spl ."--". $jmspl_cek;
