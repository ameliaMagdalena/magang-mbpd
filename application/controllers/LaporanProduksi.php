...
class LaporanProduksi extends CI_Controller {
	function __construct(){
        ...
        $this->load->model('M_LaporanProduksi');
    ...
    public function tracking_pesanan(){
        $data['po'] = $this->M_LaporanProduksi->select_all_po()->result();
        ...
        $this->load->view('v_tracking_pesanan',$data);
    }

    public function perencanaan_produksi(){
        $id = $this->input->post('id');

        $data['po']     = $this->M_LaporanProduksi->cari_po($id)->result_array();
        $data['dpo']    = $this->M_LaporanProduksi->cari_dpo($id)->result_array();
        $data['jmdpo']  = $this->M_LaporanProduksi->cari_dpo($id)->num_rows();
        ...
        $data['x']     = $this->M_LaporanProduksi->detail_pesanan($id)->result_array();
        $data['jm_x']  = $this->M_LaporanProduksi->detail_pesanan($id)->num_rows();
        $data['ct']    = $this->M_LaporanProduksi->get_cycle_time()->result_array();
        $data['jm_ct'] = $this->M_LaporanProduksi->get_cycle_time()->num_rows();
    ...
    public function surat_jalan(){
        ...
        $data['x']          = $this->M_LaporanProduksi->cari_surat_jalan($id)->result_array();
        $data['jm_x']       = $this->M_LaporanProduksi->cari_surat_jalan($id)->num_rows();
    ...
    public function invoice(){
        ...
        $data['x']          = $this->M_LaporanProduksi->cari_invoice($id)->result_array();
        $data['jm_x']       = $this->M_LaporanProduksi->cari_invoice($id)->num_rows();


        echo json_encode($data);
    }

    public function bpdb(){
        $id = $this->input->post('id');
        ...
        $data['x']          = $this->M_LaporanProduksi->cari_bpdb($id)->result_array();
        $data['jm_x']       = $this->M_LaporanProduksi->cari_bpdb($id)->num_rows();
    ...
    public function pc(){
        ...
        $data['x']    = $this->M_LaporanProduksi->get_pc()->result_array();
        $data['jm_x'] = $this->M_LaporanProduksi->get_pc()->num_rows();
