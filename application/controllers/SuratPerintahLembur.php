...
class SuratPerintahLembur extends CI_Controller {
    ...
    public function proses_spl(){
        $this->load->view('v_surat_perintah_lembur_belum_disetujui');
    }
    ...
    public function manager_setuju(){
        $this->load->view('v_surat_perintah_lembur_terkonfirmasi');
    }
    ...
    public function delete(){
        $this->load->view('v_surat_perintah_lembur_semua');
    }
    ...
    public function coba_tambah(){
        ...
        $data['line'] = $this->M_Line->cari_line_id($id_line)->result();

        $this->load->view('v_surat_perintah_lembur_tambah2', $data);
    }
