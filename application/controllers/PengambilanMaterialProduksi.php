...
class PengambilanMaterialProduksi extends CI_Controller {
    ...
    public function tambah_permintaan_pengambilan(){
      ...
      if($_SESSION['nama_departemen'] == "Produksi" && $_SESSION['nama_jabatan'] == "PIC Line Cutting" || 
         ...
         $_SESSION['nama_departemen'] == "Produksi" && $_SESSION['nama_jabatan'] == "PIC Line Assy"){
            ...
            redirect('pengambilanMaterialProduksi/semua_pengambilan_material0');
      }
    }
    ...
    public function belum_diambil_pengambilan_material0(){
        $data['line'] = $this->M_Line->select_all_aktif()->result();
    ...
    public function sudah_diambil_pengambilan_material0(){
        $data['line'] = $this->M_Line->select_all_aktif()->result();
