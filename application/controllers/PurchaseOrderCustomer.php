...
class PurchaseOrderCustomer extends CI_Controller {
    ...
    public function material_cost(){
        $data['all'] = $this->M_PurchaseOrderCustomer->selectAll()->result_array();
        $data['sedia'] = $this->M_PurchaseOrderCustomer->selectPersediaanMasuk()->result_array();
        ...
        $this->load->view("v_material_cost", $data);
    }
